...
const Footer = () => {
  return (
    // <footer className="bg-gradient-to-t from-blue-600 to-blue-800 text-white py-12">
    //   <div className="container mx-auto text-center">
    //     <p className="text-2xl md:text-3xl lg:text-4xl font-semibold mb-4">Blog Vista</p>
    //     <p className="text-lg md:text-xl lg:text-2xl opacity-80">Explore, Create, and Share Your Stories</p>
    //     <div className="mt-6 flex flex-col items-center  space-y-4">
    //       <h3 className="text-xl md:text-2xl lg:text-3xl font-bold">Follow Us on</h3>
    //       <div className="flex space-x-4">
    //         <a href="#" className="text-2xl md:text-3xl lg:text-4xl text-white hover:text-blue-200 transition duration-300">
    ...
    //     </div>
    //     <div className="mt-8">
    //       <p className="text-sm md:text-base lg:text-lg opacity-80">&copy; 2023 All Rights Reserved</p>
    //     </div>
    //   </div>
    // </footer>
